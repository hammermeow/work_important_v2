...
FROM (SELECT DISTINCT customer_grp_value,
      ...
      --LEFT JOIN nvads.dim_task_queue dtq ON wtqd.task_queue_id_key = dtq.task_queue_id
      LEFT JOIN nvads.task_queue_dim_adsc adsc ON wtqd.task_queue_id_key = adsc.task_queue_id
      LEFT JOIN nvrpt.daily_queue_analyst_metrics fqat on fqat.task_queue_id = adsc.task_queue_id
      ...
      LEFT JOIN (SELECT order_id,
                   ...
                   WHERE RNK = 1) fso ON adsc.service_order_id = fso.order_id
        ...
        LEFT JOIN (SELECT DISTINCT order_id,
                   ...
                   WHERE RNK = 1) fso2 ON adsc.service_order_id = fso2.order_id
      UNION ALL
